...
{
    /// <summary>
    /// Represents a complete DOOM format map.
    /// </summary>
    public class DoomMap : IMap
    {
        ...
        /// </summary>
        public DoomThing[] Things { get; init; } = System.Array.Empty<DoomThing>();
        ...
        /// Linedefs in the map.
        /// </summary>
        public DoomLinedef[] Linedefs { get; init; } = System.Array.Empty<DoomLinedef>();
        ...
        /// </summary>
        public DoomThing GetThing(int index) => Things[index];
        ...
        /// </summary>
        public DoomLinedef GetLinedef(int index) => Linedefs[index];
